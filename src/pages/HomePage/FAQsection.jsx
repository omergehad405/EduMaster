...
function FAQsection() {
    ...
    return (
        <section className="py-16 px-4 md:px-0 bg-(--main-color) lg:rounded-xl shadow-[0_6px_40px_0_rgba(0,0,0,0.10)]">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center text-(--second-color) mb-10">
                <span className='text-(--text-color)'>Frequently</span> Asked Questions
            </h2>
            <div className="flex flex-col gap-3 max-w-3xl mx-auto">
                {faqData.map((item, idx) => (
                    ...
                    >
                        ...
                        >
                            <span className="text-lg font-semibold text-(--text-color) text-left">{item.question}</span>
