...
function HowItWorks() {
    return (
        <section className="px-4 md:px-20 py-10 bg-(--bg-color)">
                ...
                <div className="flex flex-wrap gap-8 w-full justify-center z-10 relative">
                    {steps.map((step, idx) => (
                        ...
                        >
                            ...
                            {step.icon}
                            <h3 className="font-bold text-base mb-2 text-(--text-color) text-center">{step.title}</h3>
                ...
                {steps.map((step, idx) => (
                    <li key={idx} className="flex items-center gap-3 relative">
                        ...
                        <div className={`
                            ...
                            `}
                        >
                            <div className="font-bold text-(--text-color) mb-2">{step.title}</div>
                            <div className="text-(--p-color) text-sm">{step.desc}</div>
                        </div>
                    </li>
                ))}
            </ul>
