        ...
        <header className={`py-5 bg-(--main-color) relative transition-all duration-500 ${sidebarOpen ? 'md:pl-[250px] pl-0' : ''} px-20`}>
            ...
            <div className='hidden md:flex items-center justify-between w-full'>
                ...
                <div className='flex items-center gap-5'>
                    <Link to="/register/signUp" className='rounded-sm hidden md:block bg-(--second-color) text-(--main-color) hover:bg-(--main-color) hover:text-(--second-color) font-bold py-2 px-5 cursor-pointer border border-[--second-color] transition-all duration-500 capitalize'>signUp</Link>
