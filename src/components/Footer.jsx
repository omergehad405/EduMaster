...
function Footer() {
    return (
        <footer className="bg-(--bg-color) py-10 px-6 text-(--main-color) shadow-inner">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8 flex-wrap">
                ...
                <div className="flex flex-col items-start mb-6 md:mb-0">
                    ...
                    <p className="text-md text-(--p-color) font-semibold mt-2">Empowering learners for the future</p>
                </div>
                {/* Middle: Fast Links */}
                ...
                <div className="flex flex-col max-w-xs">
                    ...
                    <span className="block text-xs mb-5 text-gray-400 text-right">— Nelson Mandela</span>
                    <Link
                        to="/learn"
