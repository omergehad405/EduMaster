    ...
    return (
        <section className='bg-(--main-color) rounded-xl p-5 shadow'>
            <div className='flex items-center justify-between mb-5'>
                <h1 className='capitalize font-semibold text-lg text-(--text-color)'>Recent Activity</h1>
                <Link
                    to="/statistic"
            ...
            <div className="flex flex-col gap-3">
                {activities.length === 0 ? (
                    <p className="text-(--p-color) text-sm">No recent activity yet.</p>
                ) : (
                    activities.map((activity, idx) => (
                        ...
                        >
                            <div className="flex-1">
                                <div className="text-(--p-color) text-sm">{activity.description}</div>
