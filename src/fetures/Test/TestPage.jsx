    ...
    return (
        <section className="w-full min-h-screen bg-(--bg-color) px-0 md:px-4 lg:px-10 py-10 flex justify-center">
            <div className="flex flex-col lg:flex-row w-full max-w-7xl gap-8">
                {/* Sidebar FileUpload */}
                <aside className="w-full lg:w-[310px] shrink-0 mb-8 md:mb-0">
                ...
                <main className="flex-1 w-full ">
                    <div className="bg-(--bg-color) rounded-2xl shadow-2xl border border-gray-100 px-0 md:px-6 py-8 min-h-[560px] flex flex-col">
                        ...
                        {/* Tabs */}
                        <nav className="w-full flex justify-center mb-8 bg-(--main-color)">
                        ...
                        {/* Tab Content */}
                        <div className="flex flex-col items-center w-full flex-1 bg-(--bg-color)">
                            {/* Tab 1: AI Chat */}
                            {selected === 0 && (
